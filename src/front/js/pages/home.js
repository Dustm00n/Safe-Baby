    ...
    <>
      <div className="row mx-0">
        <div className="col px-0">
          <Inicio
            tituloA="Recomendaciones para el cuidado de tu bebé"
            textA="Manejar a un recién nacido"
            parrafoA="Si no ha pasado mucho tiempo cerca de recién nacidos, su fragilidad tal vez le resulte intimidante. Aquí se incluyen algunos aspectos básicos para tener en cuenta:
            ...
            textC="Todo acerca de los pañales"
            parrafoC="Probablemente, antes de volver a casa ya tenga decidido si usará pañales desechables o de tela. Sin importar cuál use, su pequeño ensuciará los pañales unas 10 veces al día, o aproximadamente 70 veces por semana.
            ...
            Después de cada movimiento de vientre o si el pañal está húmedo, coloque a su bebé boca arriba y quite el pañal sucio. Use agua, copos de algodón y un paño o toallitas para limpiar suavemente la zona genital del bebé. Al quitar el pañal de un niño, hágalo con cuidado, porque la exposición al aire puede hacer que orine. 
            Al limpiar la zona genital de una niña, límpiela de adelante hacia atrás para evitar una infección del tracto urinario. Para prevenir o curar una erupción, aplique ungüento. Recuerde siempre lavarse las manos después de cambiar un pañal.
            ...
            textE="Evita las posturas incómodas para tu bebé"
            parrafoE="Además, la seguridad es también necesaria en las actividades cotidianas. De este modo, debes tener especial precaución a la hora de vestirle y desvestirle y saber cómo hacerlo sin poner a tu pequeño en posturas incómodas.
            ...
            textF="Evita el síndrome de la muerte súbita"
            parrafoF="¿Cómo puede evitarse el síndrome de la muerte súbita?
