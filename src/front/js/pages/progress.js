        ...
        <>
            <div className="col">
                <div className="row">
                    ...
                    <EtapasActividades
                        // {
                        // ...dataActividades.map(titulo => {
                        //     return titulo.actividades.map(actividad => {
                        //         return {
                        //             titulo: titleStage5,
                        //             actividades: actividad.paragraphOne
                        //         }
                        //     })
                        // })
                        // }
            ...
            <div className="col">
                <div className="row">
                    <EtapasActividades
                        ...
                        paragraphTwo="Comienza a controlar las manos y los pies, pero estos movimientos no son sincronizados. El bebé puede comenzar a utilizar ambas manos, trabajando con ellas al mismo tiempo para cumplir tareas. El bebé todavía no es capaz de coordinar el agarre, pero manotea los objetos para acercarlos él."
                        paragraphThree="El incremento en la visión le permite diferenciar los objetos de los fondos con muy poco contraste (como un botón en una blusa del mismo color)."
                        paragraphFive="El bebé se levanta  (torso superior, los hombros y la cabeza) con los brazos cuando está acostado boca abajo (sobre el estómago)."
                        paragraphSix="Los músculos del cuello se desarrollan lo suficientemente para permitir que se siente con ayuda y mantenga la cabeza erguida."
                        paragraphSeven="Los reflejos primitivos ya han desaparecido o están comenzando a desaparecer."
                    />
                    <EtapasGraficoActividades />
                </div >
            </div>
            ...
            <div className="col">
                <div className="row">
                    <EtapasActividades
                        ...
                        paragraphTwo="El bebé puede caminar sosteniéndose de la mano de un adulto."
                        paragraphThree="El bebé puede sentarse firmemente, sin ayuda, durante largos períodos de tiempo."
                        paragraphFive="El bebé aprende a sentarse desde una posición erguida."
                        paragraphSix="El bebé puede sujetarse y mantener una posición erguida mientras se apoya en los muebles."
                    />
                    <EtapasGraficoActividades />
                </div >
            </div>
